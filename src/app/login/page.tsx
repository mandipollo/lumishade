...
// import { syncCartLogin } from "@/store/features/cart/cartSlice";
...
// 			// dispatch action
// 			dispatch(syncCartLogin(response.data.cart));
		...
		<SignIn
			appearance={{
				elements: {
					...
					rootBox:
						"flex flex-col gap-4 h-[calc(100vh-3rem)] w-full justify-center items-center bg-white",
					header: "",
				},
			}}
		/>
